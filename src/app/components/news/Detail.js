    ...
    <div className='py-[100px] bg-[#eeeff3]'>
        <div className='bg-white mx-[20px] p-[20px] md:mx-16 md:p-16'>
            ...
            <div className=''>
                ...
                { currentAdmin && <div onClick={() => router.push(`edit/${news._id}`)} className='flex text-white items-center text-[15px] gap-1 cursor-pointer bg-[#3b71b9] mt-3 px-7 py-1 rounded-[3px] w-[113px]'>Modifier<FiEdit3 /></div>}
