          ...
          <div className="flex justify-between items-center w-[100%]">
            <div className="md:w-[50%]">
                <div className="w-[100%]" data-aos="fade-right" data-aos-delay="100">
                    ...
                    <p className="text-sm md:text-[16px] md:pb-5 text-[rgba(0,0,0,0.7)] font-light md:leading-7">{"Traduction et accompagnement dans l'environnement numérique des processus des organisations éducatives et des instances dirigeantes"}</p>
                </div>
